    ...
    <footer className="bg-gradient-to-b from-slate-900 to-slate-950 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Tu escuela de kitesurf en Salinas del Rey, Colombia. 
              Aprende con los mejores instructores en condiciones de viento perfectas.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://instagram.com/veronikite"
                target="_blank"
              ...
              <a
                href="https://facebook.com/veronikite"
                target="_blank"
                rel="noopener noreferrer"
          ...
          {/* Explore */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-cyan-400">Explorar</h3>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:info@veronikite.com" className="hover:text-white transition-colors">
                  info@veronikite.com
                </a>
              </li>
              <li className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>
            &copy; {currentYear} Veroni Kite School. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
